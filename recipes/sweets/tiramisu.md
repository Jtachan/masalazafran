...
**Ingredients** (8 portions / 2 small trays)

- _Ladyfingers_
- _Coffee_ (2 espressos)
- _Sugar_ (120 g)
- _Eggs_ (4 medium)
- _Mascarpone_ (500 g)
- _Bitter cocoa powder_
- _Orange liquor_ (Optional) — Mixed with the coffee
- _Vanilla essence_ (Optional) — Mixed with the coffee

!!! Note
    The image displaying the recipe corresponds to half the ingredients here.
...
2. Mix the yolks with half of the sugar until homogeneous. Add the Mascarpone and mix until there is no clumps.
...
5. Prepare the container that will have the mascarpone with a thin base of the batter.
